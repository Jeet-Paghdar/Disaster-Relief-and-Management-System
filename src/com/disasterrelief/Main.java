    ...
    private static void seedDatabase() {
        ...
        try (java.sql.Connection conn = com.disasterrelief.utils.DBConnection.getConnection();
            ...
            if (rs.next() && rs.getInt("total") == 0) {
                ...
                stmt.addBatch(
                        "INSERT INTO GOVT_AGENCY (AGENCY_NAME, BUDGET_CODE) VALUES ('NDMA (National Disaster Management Authority)', 'BGT-IN-01')");
                stmt.addBatch(
                        "INSERT INTO GOVT_AGENCY (AGENCY_NAME, BUDGET_CODE) VALUES ('NDRF (National Disaster Response Force)', 'BGT-IN-02')");
                stmt.addBatch(
                        "INSERT INTO GOVT_AGENCY (AGENCY_NAME, BUDGET_CODE) VALUES ('NIDM (National Institute of Disaster Management)', 'BGT-IN-03')");
                stmt.executeBatch();
            }
        } catch (Exception e) {
